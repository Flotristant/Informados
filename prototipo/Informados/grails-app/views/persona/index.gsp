		...
		<div id="list-persona" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="userName" title="${message(code: 'persona.userName.label', default: 'User Name')}" />
						...
						<g:sortableColumn property="suscripcion" title="${message(code: 'persona.suscripcion.label', default: 'Suscripcion')}" />
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personaInstance, field: "userName")}</td>
					
						<td>${fieldValue(bean: personaInstance, field: "password")}</td>
					
						<td>${fieldValue(bean: personaInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: personaInstance, field: "suscripcion")}</td>
