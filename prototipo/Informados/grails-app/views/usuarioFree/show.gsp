...
<html>
	...
	<body>
		...
		<div id="show-usuarioFree" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:usuarioFreeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${usuarioFreeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
