	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="registro" controller = "persona"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="index" controller="diario"> Diarios </g:link></li>
			</ul>
		</div>
